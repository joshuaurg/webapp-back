...
<body>
    ...
    <%@ include file="/WEB-INF/views/back/head.jsp"%>
        <div class="wrapper wrapper-content animated fadeInRight">
            <div class="row">
                <div class="col-lg-12">
                	<form class="form-horizontal" action="${_base}/poem/back/add" method="post" id="addPoem" enctype="multipart/form-data">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">作者: </label>
                        <div class="col-sm-3">
	                        <input class="form-control" type="text" id="author" name="author" value="${poem.author }">
	                   	</div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">标题: </label>
                        <div class="col-sm-3">
	                       <input class="form-control" type="text" id="title" name="title" value="${poem.title }">  
	                   	</div>
                    </div>
                    <div class="form-group">
