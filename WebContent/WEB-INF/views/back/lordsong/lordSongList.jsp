...
<body>
    ...
    <%@ include file="/WEB-INF/views/back/head.jsp"%>
        <div class="wrapper wrapper-content animated fadeInRight">
	        <div class="row">
                <div class="col-lg-12">
                	<button type="button" onclick="addLordSong()" class="btn btn-success">添加诗歌</button>
        		</div>
	        </div>
            <div class="row">
                <div class="col-lg-12">
...
<script type="text/javascript">
	$(document).ready(function(){
		$('#table').jqGrid({
			url : "${ctx}/belief/back/lordsong/list",
			datatype : "json",
			mtype : "GET",
			height: 600,
			autowidth: true,
	...
	function addLordSong(){
		window.location.href = "${ctx}/belief/lordsong/back/add/view";
	}
